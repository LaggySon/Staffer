...
<div
	class="grid grid-cols-3  bg-slate-300 dark:bg-slate-800  cursor-pointer transition-all overflow-hidden before:w-0 before:bg-blue-400 before:absolute hover:before:w-full before:h-10 before:transition-all before:duration-300 before:left-1/2 hover:before:left-0"
>
